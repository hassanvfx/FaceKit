...
The following is a swift wrapper for the C++  implementation of PRNet on iOS

References:
- Original Work:
https://github.com/taylorlu/FaceConverter

- Facenet-Caffe A server Side implementation for f
https://github.com/taylorlu/Facenet-Caffe

# Requirements
You will need to link the following XCFrameworks, please reach out in case you need them:
